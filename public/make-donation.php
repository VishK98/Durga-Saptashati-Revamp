        ...
        <div class="row">
                ...
                <div style="background:#fff;border-radius:14px;padding:35px;box-shadow:0 5px 25px rgba(0,0,0,0.06);">
                    ...
                    <form id="donationForm" onsubmit="return false;">
                        ...
                        <div style="margin-bottom:15px;">
                            <label style="display:block;margin-bottom:6px;font-weight:600;font-size:0.85rem;color:#333;">Cause</label>
                            <select name="cause"
                                style="width:100%;padding:12px 16px;border:1.5px solid #e5e7eb;border-radius:10px;font-size:0.9rem;font-family:inherit;transition:all 0.3s;background:#f9fafb;"
                                onfocus="this.style.borderColor='#f26522';this.style.boxShadow='0 0 0 3px rgba(242,101,34,0.1)';this.style.background='#fff'"
                                onblur="this.style.borderColor='#e5e7eb';this.style.boxShadow='none';this.style.background='#f9fafb'">
            ...
            <div class="col-lg-5 mb-4" data-aos="fade-left">
                ...
                <div style="background:#fff;border-radius:14px;padding:30px;box-shadow:0 5px 25px rgba(0,0,0,0.06);margin-bottom:20px;">
                    <h5 style="color:#1a1b2e;font-weight:700;margin-bottom:18px;"><i class="fas fa-university" style="color:#f26522;margin-right:8px;"></i> Bank Transfer Details</h5>
                    <div style="background:#f9fafb;border-radius:10px;padding:18px;">
                        <div style="margin-bottom:10px;"><small style="color:#999;font-size:0.78rem;">Account Name</small><p style="margin:2px 0 0;font-weight:600;color:#1a1b2e;font-size:0.9rem;">Durga Saptashati Foundation</p></div>
                        <div style="margin-bottom:10px;"><small style="color:#999;font-size:0.78rem;">Account Number</small><p style="margin:2px 0 0;font-weight:600;color:#1a1b2e;font-size:0.9rem;">XXXX XXXX XXXX XXXX</p></div>
                        <div style="margin-bottom:10px;"><small style="color:#999;font-size:0.78rem;">IFSC Code</small><p style="margin:2px 0 0;font-weight:600;color:#1a1b2e;font-size:0.9rem;">XXXXXXXXXX</p></div>
                        <div><small style="color:#999;font-size:0.78rem;">Bank</small><p style="margin:2px 0 0;font-weight:600;color:#1a1b2e;font-size:0.9rem;">State Bank of India</p></div>
                    </div>
                </div>

                <!-- UPI -->
                <div style="background:#fff;border-radius:14px;padding:30px;box-shadow:0 5px 25px rgba(0,0,0,0.06);margin-bottom:20px;">
                    <h5 style="color:#1a1b2e;font-weight:700;margin-bottom:15px;"><i class="fas fa-mobile-alt" style="color:#f26522;margin-right:8px;"></i> UPI Payment</h5>
                    <div style="background:#f9fafb;border-radius:10px;padding:18px;text-align:center;">
                        <div style="width:150px;height:150px;background:#e5e7eb;border-radius:10px;display:flex;align-items:center;justify-content:center;margin:0 auto 12px;">
                            <i class="fas fa-qrcode" style="font-size:3rem;color:#999;"></i>
                        </div>
                        <p style="color:#888;font-size:0.82rem;margin:0;">Scan QR code or use UPI ID</p>
                        <p style="color:#1a1b2e;font-weight:600;font-size:0.9rem;margin:5px 0 0;">donate@saptashati</p>
                    </div>
                </div>
