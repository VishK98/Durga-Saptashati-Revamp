...
$causes = [
    ...
    ['title' => 'Sanitary Pads Distribution', 'icon' => 'fa-hand-holding-heart', 'url' => 'sanitary-pads-distribution.php', 'img' => 'sanitary-pads-distribution/sanitary-pads-distribution.webp', 'desc' => 'Distributing free sanitary pads to underprivileged women and girls, promoting menstrual hygiene awareness.', 'tag' => 'Hygiene'],
    ...
    ['title' => 'Disaster Relief', 'icon' => 'fa-hands-helping', 'url' => 'disaster-relief.php', 'img' => 'hungary/hungary-2.webp', 'desc' => 'Emergency response, rehabilitation support, and relief material distribution during disasters.', 'tag' => 'Relief'],
