...
<div class="page-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12"><h2>Saree Run</h2></div>
            <div class="col-12">
        ...
        <div class="row min-vh-80 align-items-center">
            <div class="col-lg-7" data-aos="fade-right" data-aos-duration="1000">
                ...
                <h1 class="hunger-hero-title">
                    The Vibrant
                    <span class="hunger-highlight">Saree Run</span>
                </h1>

                <p class="hunger-hero-desc">
                    A unique event celebrating Indian women's strength, culture, and fitness.
                    Women from all walks of life come together for a vibrant community run in sarees,
                    breaking stereotypes and promoting health, unity, and women empowerment.
                </p>

                <div class="hunger-info-row">
                    <div class="hunger-info-card">
                        <div class="hunger-info-icon"><i class="fas fa-running"></i></div>
                        <div>
                            <h4>"Run with Pride, Run in Saree"</h4>
                            <p>Breaking stereotypes, one stride at a time</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-5" data-aos="fade-left" data-aos-delay="200" data-aos-duration="1000">
                <div class="hunger-stats-grid">
                    <div class="hunger-stat-card" data-aos="zoom-in" data-aos-delay="100">
                        <div class="hunger-stat-icon"><i class="fas fa-female"></i></div>
                        <div class="hunger-stat-number" data-counter="300">0</div>
                        <div class="hunger-stat-label">Women Participants</div>
                    </div>
                    <div class="hunger-stat-card" data-aos="zoom-in" data-aos-delay="200">
                        <div class="hunger-stat-icon"><i class="fas fa-road"></i></div>
                        <div class="hunger-stat-number" data-counter="5">0</div>
                        <div class="hunger-stat-label">KM Run</div>
                    </div>
                    <div class="hunger-stat-card" data-aos="zoom-in" data-aos-delay="300">
                        <div class="hunger-stat-icon"><i class="fas fa-map-marker-alt"></i></div>
                        <div class="hunger-stat-number" data-counter="3">0</div>
                        <div class="hunger-stat-label">Cities</div>
                    </div>
                    <div class="hunger-stat-card" data-aos="zoom-in" data-aos-delay="400">
                        <div class="hunger-stat-icon"><i class="fas fa-award"></i></div>
                        <div class="hunger-stat-number" data-counter="10">0</div>
                        <div class="hunger-stat-label">Awards Given</div>
                    </div>
                </div>
            </div>
        </div>
...
<section class="hunger-gallery-section" id="gallery">
    <div class="container-fluid">
        <div class="hunger-section-header text-center" data-aos="fade-up">
            ...
            <h2 class="hunger-section-title">Saree Run Moments</h2>
            <p class="hunger-section-desc">
                Relive the energy, colour, and spirit of our Saree Run events where women
                celebrated strength, culture, and fitness together.
            </p>
        </div>
...
<script>
var sareeData = <?= json_encode(array_map(function($img) { return ['src' => url('assets/images/saree/' . $img['file']), 'title' => $img['title']]; }, $sareeImages)) ?>;
var sareeIdx = 0;
function openSareeLightbox(i) { sareeIdx = i; updateSareeLb(); document.getElementById('sareeLightbox').style.display = 'flex'; document.body.style.overflow = 'hidden'; }
function closeSareeLightbox() { document.getElementById('sareeLightbox').style.display = 'none'; document.body.style.overflow = ''; }
function updateSareeLb() { document.getElementById('sareeLbImg').src = sareeData[sareeIdx].src; document.getElementById('sareeLbTitle').textContent = sareeData[sareeIdx].title; }
function sareePrev() { sareeIdx = (sareeIdx - 1 + sareeData.length) % sareeData.length; updateSareeLb(); }
function sareeNext() { sareeIdx = (sareeIdx + 1) % sareeData.length; updateSareeLb(); }
document.getElementById('sareeLightbox').addEventListener('click', function(e) { if (e.target === this) closeSareeLightbox(); });
