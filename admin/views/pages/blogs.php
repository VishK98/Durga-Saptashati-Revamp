...
<div id="blogModal" class="blog-modal-overlay">
    <div class="blog-modal-box blog-modal-form" id="blogModalInner">
        ...
        <form id="blogForm" method="POST" action="admin?page=blogs" enctype="multipart/form-data">
...
<div id="deleteModal" class="blog-modal-overlay blog-modal-overlay-delete">
    <div class="blog-modal-box blog-modal-delete">
        ...
        <form id="deleteForm" method="POST" action="admin?page=blogs">
...
<!-- Hidden toggle form -->
<form id="toggleForm" method="POST" action="admin?page=blogs" hidden>
