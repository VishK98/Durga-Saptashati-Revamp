...
<div class="db-bottom-grid">
    ...
    <div class="db-table-card">
        <div class="db-table-header">
            ...
            <a href="admin.php?page=donations" class="db-table-link">View All
    ...
    <div class="db-table-card">
        <div class="db-table-header">
            ...
            <a href="admin.php?page=members" class="db-table-link">Manage <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="db-table-body">
...
<div class="db-activity-grid">
    ...
    <div class="db-activity-card">
        <div class="db-activity-header">
            ...
            <a href="admin.php?page=members" class="db-activity-link">View All <i class="fas fa-arrow-right"></i></a>
        </div>
    ...
    <div class="db-activity-card">
        <div class="db-activity-header">
            ...
            <a href="admin.php?page=donations" class="db-activity-link">View All <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="db-activity-body">
...
<div class="db-activity-grid--mt20">
    ...
    <div class="db-activity-card">
        <div class="db-activity-header">
            ...
            <a href="admin.php?page=volunteers" class="db-activity-link">View All <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="db-activity-body">
    ...
    <div class="db-activity-card">
        <div class="db-activity-header">
            ...
            <a href="admin.php?page=queries" class="db-activity-link">View All <i class="fas fa-arrow-right"></i></a>
        </div>
        <div class="db-activity-body">
